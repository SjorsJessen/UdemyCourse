...
int main()
{
    ...
    cout << "Total estimate: $" 
    << 
    ((price_per_small_room * number_of_small_rooms) + (price_per_small_room * number_of_small_rooms * sales_tax)) + 
    ((price_per_large_room * number_of_large_rooms) + (price_per_large_room * number_of_large_rooms * sales_tax)) 
    << endl;
